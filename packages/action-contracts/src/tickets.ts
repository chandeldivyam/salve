...
export const ticketActions = {
  ...
  reply: defineAction({
    ...
    rest: { method: 'POST', path: '/tickets/:ticketId/replies', pathParams: ['ticketId'] },
  ...
  note: defineAction({
    ...
    rest: { method: 'POST', path: '/tickets/:ticketId/notes', pathParams: ['ticketId'] },
